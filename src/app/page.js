          ...
          <div className="container">
            <Slide delay={0.7}>
              <div className={styles.Content}>
                <p>
                  <span>Ingredients Bank™</span> is a digital marketing website
                  where you can find Nutraceutical Ingredients for your
                  supplement formulation. Our ingredients are manufactured in
                  India, and distributed globally through our supply chain
                  system. Our distribution centers are located in USA, UK, EU &
                  UAE. Ingredients Bank trademark owner is Novel Nutrientss,
                  certified for FSSC 22000, Kosher, Halal, GMP, and Organic
                  certification from reputed certifying bodies. We have a strong
                  technical team to manufacture Nutra- ceuticals as per Global
                  regulatory standards to supply them globally. We comply with
                  the Ethical Business System. You can trust quality and
                  performance because, through our continual global food hygiene
                  and safety culture practices, we ensure that manufactured
                  products are tested at each stage of the process and assure
                  customers a high degree of confidence
                </p>
                <p>
